...
/
  ...
  CREATE OR REPLACE FORCE VIEW "TEST"."NSEARCH" ("RNUM", "NNO", "CNAME", "NTITLE", "NCONTENT", "T_NAME", "VIEW_CT", "NDATE", "ST") AS 
  select rownum rnum, A."NNO",A."CNAME",A."NTITLE",A."NCONTENT",A."T_NAME",A."VIEW_CT",A."NDATE",A."ST"
...
A;
  ...
  CREATE OR REPLACE FORCE VIEW "TEST"."NLIST" ("RNUM", "NNO", "CNAME", "NTITLE", "NCONTENT", "T_NAME", "VIEW_CT", "NDATE", "ST") AS 
  select rownum rnum, a."NNO",a."CNAME",a."NTITLE",a."NCONTENT",a."T_NAME",a."VIEW_CT",a."NDATE",a."ST"
from(
...
A;
  ...
  CREATE OR REPLACE FORCE VIEW "TEST"."NDETAIL" ("NNO", "CNAME", "NTITLE", "NCONTENT", "NWRITER", "T_NAME", "VIEW_CT", "NDATE", "ST") AS 
...
where n.st = 'Y';
  ...
  CREATE OR REPLACE FORCE VIEW "TEST"."BLIST" ("RNUM", "BID", "BTYPE", "CNAME", "BTITLE", "BCONTENT", "T_NAME", "VIEW_CT", "CREATE_DATE", "MODIFY_DATE", "ST") AS 
  select rownum rnum, A."BID",A."BTYPE",A."CNAME",A."BTITLE",A."BCONTENT",A."T_NAME",A."VIEW_CT",A."CREATE_DATE",A."MODIFY_DATE",A."ST"
...
order by bid desc) A;
  ...
  CREATE OR REPLACE FORCE VIEW "TEST"."BDETAIL" ("BID", "BTYPE", "CNAME", "BTITLE", "BCONTENT", "BWRITER", "T_NAME", "VIEW_CT", "CREATE_DATE", "MODIFY_DATE", "ST") AS 
